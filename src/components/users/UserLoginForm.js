...
handleLoginSubmit = evt => {
  ...
  // verifyUser is a prop in UserLoginForm
  this.props.verifyUser(this.state.userName, this.state.password).then(user => {
    ...
    //   console.log("userId");
      return UsersManager.getUsersGames(userId).then(user => {
        // console.log(user);
        this.setState({
          games: user.games
        });
